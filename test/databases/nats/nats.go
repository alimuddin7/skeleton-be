...
type (
	...
	NatsDatabase interface {
		GetConn() *nats.Conn
		GetJS() nats.JetStreamContext
	}
)

func InitializeNatsDatabase(nc *nats.Conn, js nats.JetStreamContext, log zerolog.Logger) NatsDatabase {
	return &natsDatabase{
		Conn: nc,
		JS:   js,
		Logs: log,
...
func (n *natsDatabase) GetConn() *nats.Conn {
	return n.Conn
}

func (n *natsDatabase) GetJS() nats.JetStreamContext {
	return n.JS
}
